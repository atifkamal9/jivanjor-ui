...
export default function MainCategories() {
  ...
  return (
    <section className="flex flex-col lg:flex-row justify-between leading-normal max-w-360 mx-auto my-4 sm:my-6 lg:my-9 px-5 lg:px-8 xd:px-10 3xl:px-8 gap-4 lg:gap-12 z-100">

...
export default function ProductCategories({ category, data, onCategoryChange }: Props) {
  ...
  return (
    <section className="flex flex-col lg:flex-row justify-between max-w-360 mx-auto my-4 sm:my-6 lg:my-12 xd:my-18 px-5 lg:px-8 hd:px-10 3xl:px-8 gap-12 z-100">

  ...
  return (
    <section className="">
      <div className="relative mb-10 lg:mb-12 bg-linear-to-r from-[#FF0009] to-[#772571] text-white">
        ...
        <div className="flex flex-col justify-center text-center md:text-start mx-auto max-w-360 space-y-4 xd:space-y-6 py-24 px-5 lg:px-8 xd:px-10 2xl:px-8 lg:py-14">

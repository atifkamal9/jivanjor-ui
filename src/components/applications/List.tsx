...
function ListContent({
  ...
  return (
    <div className="w-full">
        ...
        <>
          <section className="flex flex-col justify-between max-w-360 mx-auto my-3 md:my-5 px-5 gap-2.5 z-50 font-google-sans">
            <div className="flex items-center gap-1.5 text-xs sm:text-sm md:text-base font-medium">
              ...
              <ChevronRight size={16} />
              <span className="text-foreground/70 line-clamp-1 max-w-[200px] sm:max-w-xs md:max-w-md">
                {activeArticle.title}
              </span>
            </div>
      ...
      <section className="max-w-360 mx-auto px-5 pt-4 lg:pt-8 w-full leading-normal text-[#222]">

...
export default function Reach() {
  ...
  return (
    <section className="relative max-w-360 mx-auto w-full px-5 lg:px-8 pt-5 lg:pt-14">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6.5 items-start text-[#222]">
        {/* Left Column - App Info and Feature Cards */}
        <div className="lg:col-span-8 flex flex-col space-y-4">
          <h3 className="font-amethysta text-[34px] md:text-4xl text-center md:text-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="hidden md:block col-span-7 max-w-md space-y-4">
              <p className="text-lg md:text-2xl">
                Download the Jivanjor Achievers Club App to enrol, access
                contractor benefits, track rewards and stay connected.
              </p>
              <div>
                <a
                  target="_blank"
            ...
            <div className="flex flex-col items-center text-center md:hidden space-y-4 max-w-85">
              <p className="text-lg">
                Download the Jivanjor Achievers Club App to enrol, access
                contractor benefits, track rewards and stay connected.
              </p>
          ...
          {/* Feature Cards Box */}
          <div className="w-full bg-linear-to-r from-[#E7071C] to-[#772571] text-white rounded-[20px] p-10 md:p-12">
        ...
        {/* Right Column - Reach out to Us Form Card */}
        <div className="lg:col-span-4 w-full bg-white rounded-[20px] shadow-[4px_4px_12px_4px_rgba(0,0,0,0.1)] overflow-hidden">
          {/* Card Header */}

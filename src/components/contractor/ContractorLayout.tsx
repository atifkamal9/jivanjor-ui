...
import { ReachLeft, ReachForm } from "./Reach";
...
export default function ContractorLayout({ data = {} }: ContractorLayoutProps) {
  const [isOpen, setIsOpen] = useState(true);
  const [isSticky, setIsSticky] = useState(false);

  return (
    <main className="min-h-screen relative bg-background font-google-sans overflow-x-clip">
      <Hero hideText={isSticky || !isOpen} data={data.hero} />
      ...
      {/* Main Grid Wrapper */}
      <div className="max-w-360 mx-auto w-full px-5 lg:px-8 xd:px-10 2xl:px-8 py-10 lg:py-13">

...
export default function BlogContent({
  ...
  return (
    <div className="w-full">
      {/* Hero Image Section */}
      <section className="max-w-360 mx-auto px-5 lg:px-8 hd:px-12 3xl:px-8 mb-6">
      ...
      <section className="flex flex-col lg:flex-row justify-between max-w-360 mx-auto px-5 lg:px-8 hd:px-12 3xl:px-8 gap-5 lg:gap-10 relative">
      ...
      {relatedPosts.length > 0 && (
        <section className="bg-white">
          <div className="max-w-360 mx-auto p-5 lg:px-8 hd:px-12 3xl:px-8 py-12 md:py-18 space-y-6">

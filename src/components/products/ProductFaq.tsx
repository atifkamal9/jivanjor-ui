...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer: "Supremo boasts a superfast setting time of just 1 hour, though this may vary slightly depending on environmental temperature and humidity."
  },
  {
    question: "What is the coverage area for 1 Kg of Supremo?",
    answer: "Jivanjor Supremo provides coverage of approximately 60-70 sq.ft per kg, depending on the thickness of application and porosity of the substrate."
  },
  {
    question: "Is Supremo waterproof?",
    answer: "Supremo is standard premium white adhesive offering excellent heat and general moisture resistance. For high exposure water areas, Jivanjor Watershield or Aquabond is recommended."
  },
  {
    question: "What pack sizes are available for commercial use?",
    answer: "Supremo is available in various packaging formats including 1 Kg, 2 Kg, 5 Kg, 10 Kg, 20 Kg, 30 Kg, 50 Kg, and 60 Kg to meet diverse commercial project requirements."
  }
];
...
export default function ProductFaq() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16 space-y-16 lg:space-y-20">
      ...
      <div className="space-y-8">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <p className="text-sm sm:text-base text-neutral-500 leading-relaxed">
            Find quick answers about product use, coverage, setting time, pack sizes and technical details.
          </p>
        </div>

        {/* FAQs Container Card */}
        <div className="bg-[#F6F6F6] rounded-[28px] p-6 sm:p-10 lg:p-12 border border-neutral-100/50 shadow-2xs max-w-4xl mx-auto">
          <div className="w-full border-b border-neutral-300">
            {FAQ_ITEMS.map((item, idx) => {
              const isOpen = openIndex === idx;
              return (
                <div key={item.question} className="border-t border-neutral-300 overflow-hidden">
                  ...
                  <div
                    className={`transition-all duration-300 ease-in-out ${
                      isOpen ? "max-h-[300px] opacity-100 pb-5" : "max-h-0 opacity-0 pointer-events-none"
                    }`}
                  >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 lg:gap-10">
          ...
          <div className="text-center md:text-left space-y-2 max-w-xl">
            ...
            <p className="text-xs sm:text-sm opacity-90 leading-relaxed font-light">
              Share your woodwork needs, product query or application concerns. Our team will help you find the right Jivanjor solution.
            </p>
          </div>

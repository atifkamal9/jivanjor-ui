                  ...
                  <div className="space-y-6 animate-[fadeIn_0.15s_ease-out]">
                    <div className="flex items-center justify-between border-b border-border pb-3">
                      ...
                      <label className="flex items-center gap-2 px-3 py-1.5 rounded-xl border border-border bg-surface/50 cursor-pointer select-none">
                        <input
                          type="checkbox"
                          checked={formData.sections.professionals.enabled !== false && formData.sections.professionals.hideSection !== true && formData.sections.professionals.hide !== true}
                          onChange={(e) => {
                            const isVisible = e.target.checked;
                        ...
                        />
                        <span className="text-xs font-bold text-foreground">
                          {formData.sections.professionals.enabled !== false && formData.sections.professionals.hideSection !== true && formData.sections.professionals.hide !== true

...
import { Plus, Search, Edit2, Trash2, X, Sparkles, Lightbulb, ArrowLeft } from "lucide-react";
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-zinc-800">
                  {loading ? (
                    <tr>
                      <td colSpan={3} className="p-10 text-center text-sm font-semibold text-gray-400 dark:text-zinc-50 bg-surface/5">
          ...
          <div className="flex items-center gap-3 border-b border-gray-100 dark:border-zinc-800 pb-5 shrink-0">
            ...
            <div>
              <h1 className="text-2xl font-black text-gray-900 dark:text-zinc-50 flex items-center gap-2">
                ...
                <span>{editingId ? "Modify Use Case Details" : "Record Application Use Case"}</span>
              </h1>
              <p className="text-sm font-semibold text-gray-400 dark:text-zinc-500 uppercase tracking-wider">
                Establish professional project guides, narrative applications, instructions, and target recommendations
              </p>
            </div>
          </div>
